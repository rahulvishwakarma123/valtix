      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              {[
                { value: "100%", label: "Transparent", color: "text-green-400" },
                { value: "24/7", label: "Auto-compound", color: "text-blue-400" },
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { number: "1", title: "Input", description: "Tell our AI what you need", color: "bg-blue-500" },
              { number: "2", title: "Process", description: "Watch as intelligent algorithms work their magic", color: "bg-purple-500" },
              { number: "3", title: "Output", description: "Receive perfectly tailored results", color: "bg-green-500" }
            ].map((step, index) => (
              <motion.div 
                key={index}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {[
              { emoji: "⚡", title: "10x Faster", description: "Accomplish more in less time" },
              { emoji: "🎯", title: "Zero Learning Curve", description: "Intuitive for everyone" },
              { emoji: "🚀", title: "Always Improving", description: "Gets smarter with every use" },
              { emoji: "🛡️", title: "Enterprise-Grade", description: "Reliable and secure" }
            ].map((benefit, index) => (
              <motion.div
                key={index}
